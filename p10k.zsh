# Generated by Powerlevel10k configuration wizard on 2022-01-24 at 14:05 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    # (( VCS_STATUS_NUM_CONFLICTED )) && res+="${conflicted}${R}x${VCS_STATUS_NUM_CONFLICTED}$RESET"
    # # +42 if have staged changes.
    # (( VCS_STATUS_NUM_STAGED     )) && res+="${modified}${C}●${VCS_STATUS_NUM_STAGED}$RESET"
    # # !42 if have unstaged changes.
    # (( VCS_STATUS_NUM_UNSTAGED   )) && res+="${modified}${Y}+${VCS_STATUS_NUM_UNSTAGED}$RESET"
    # # ?42 if have untracked files. It's really a question mark, your font isn't broken.
    # # See POWERLEVEL9K_VCS_UNTRACKED_ICON above if you want to use a different icon.
    # # Remove the next line if you don't want to see untracked files at all.
    # (( VCS_STATUS_NUM_UNTRACKED  )) && res+="${untracked}${RED}${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}$RESET"
